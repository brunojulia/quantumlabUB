...
np.save('nromahvhdx{}dt{}.npy'.format(deltax,deltat),normalitzacio)	
np.save('psihvhdx{}dt{}.npy'.format(deltax,deltat),psivector)
np.save('tvechvhdx{}dt{}.npy'.format(deltax,deltat),tvec)
np.save('Vvechvhdx{}dt{}.npy'.format(deltax,deltat),Pvec)
np.save('dadeshvh0.03dx0.01dt.npy',dxdydt)
