...
def psi_ev_ck(psi,V,r,dl,dt):
    ...
    for j in range(box_shape[1]):
        ...
        D[:,0]=psi[:,0,0]*(1-1j*2*r-1j*dt*V[:,0]/4)+1j*r*(psi[:,1,0])
...
guarda9=1
if guarda9==1:
    anim9.save(str(Nslt)+'_slits_Sch_v2.mp4', writer=writer)
