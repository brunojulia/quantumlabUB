...
z0=4 #initial position 
g=0 #interaction term, -1 for bright solitons, 1 for grey solitons
...
check=[]
for position in z:
    check.append(bright(position,ev_time,v,n,z0))
