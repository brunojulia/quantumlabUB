...
class Inici(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        efecte_tunel = Button(text='Efecte túnel: explicació científica', size_hint=(0.5, 0.25), pos_hint={'center_x': 0.5})
    ...
    def efecte_tunel(self, instance):
        explicacio = Label(text='L\'efecte túnel és un dels fenomens més fascinants del món quàntic: permet a les partícules passar a través de barreres de potencial que clàssicament no podrien superar.\n\n\n'
                   'Imaginem-nos una bola atrapada dins un recipient (com un bol). '
                   'En la mecànica clàssica, la bola només pot sortir del recipient si té prou energia per pujar fins la vora del recipient i sortir-ne.'
                   'Però en la mecànica quàntica, la bola pot travessar el recipient directament -com si fes un túnel a través d\'ell-, encara que no tingui prou energia per pujar fins la vora d\'aquest.\n\n\n'
                   ...
                   'Aquestes ones poden propagar-se a través de barreres i, per tant, hi ha una probabilitat no nul·la de que les partícules es trobin en una regió on clàssicament no podrien estar.\n\n\n')
        explicacio.bind(size=explicacio.setter('text_size'))
        imatge = Img(source='efectetunel.jpg', keep_ratio=True, allow_stretch=True)
