...
#        self.trk_psi_data, = self.psi_twin.plot(self.mesh, self.psi0) 
        ...
        """
        #Plotting velocity
        self.plt_vel_factor = 1 #Factor in time exponential
        self.vel_correc = 0. #Correction for plotting continuous time
        #Pausing
...
#        Clock.schedule_interval(self.all_plotpsiev, 1/30.)
    ...
    def change_vel(self):
        """
        Changes the factor in the time exponential in ary_compexp from
        plotpsiev().
        """
        vel1 = self.plt_vel_factor #Before changing
        ...
        vel2 = self.plt_vel_factor #After changing
        
        self.vel_correc += (Clock.get_time() - self.rst_time) * (vel2- vel1)
    ...
    def plotpsiev(self, dt):
        ...
        #Also we added the corrections when changing velocity.
        
        
        t = self.plt_vel_factor * (Clock.get_time() - self.rst_time)\
            - self.vel_correc
...
#  
    ...
    def measure(self):
        ...
        self.vel_correc = 0. #The acumulative correction has to be restarted 
        #after measuring, otherwise it would acuulated at infinitum.
        #Updating the text in the kivy's labels (these variables come from the 
        #kivy file).
        self.label1.text = 'New mu0:   ' + '%.1f' % self.mu0 + '\n' \
                           'Prob.:          ' + '%.2f' \
