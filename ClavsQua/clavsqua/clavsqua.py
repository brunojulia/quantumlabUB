...
class Clavsqua(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.startstopbut_qua.background_down = "pics/playblue.png"
        self.startstopbut_qua.background_normal = "pics/play.png"
...
#Quantum functions:
    ...
    def start_stop(self):
        if self.switch1_qua == "off":
            self.startstopbut_qua.background_normal = "pics/pause.png"
            self.startstopbut_qua.background_down = "pics/playblue.png"
            self.switch1_qua = "on"
        elif self.switch1_qua == "on":
            self.startstopbut_qua.background_normal = "pics/play.png"
            self.startstopbut_qua.background_down = "pics/pauseblue.png"
            self.switch1_qua = "off"
...
class Computevolution_qua(object):
    ...
    """
    def __init__(self, progressbar, projection, clavsqua):
        self.a = clavsqua
        self.pb = progressbar
        self.pro = projection
