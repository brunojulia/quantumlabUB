...
aplot=[]
a_m0inv=[]  #Initial state of path after spontanous decay
for i in range(dim):
...
#CHANGE OF STATE
a_m0change=a_m0inv.copy()
a_m0change[0]=a_m0inv[2]
a_m0change[2]=0+0j
...
B = 0.3
#solve
a_m2=solve_ivp(odes, At2, a_m0change)   #Note At2 and a_m0inv
