        ...
        if GameScreen.estat==1:
            if GameScreen.Counter==0:
                ...
                if self.mlt==3:
                    ...
                    self.rec_1.pos=(30,150)
                    self.rec0.pos = (30 + 1 * self.prob_space, 150)
                    self.rec1.pos=(30+2*self.prob_space,150)

                    self.erec_1.pos = (500 + 0 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][0] * 100)
                    self.erec0.pos = (500 + 1 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][1] * 100)
                    self.erec1.pos = (500 + 2 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][2] * 100)


                    self.tag_1.pos=(30+0*self.prob_space+self.prob_space/2.-15,125)
                    self.tag0.pos=(30+1*self.prob_space+self.prob_space/2.-15,125)
                    self.tag1.pos=(30+2*self.prob_space+self.prob_space/2.-15,125)

                    self.etag_1.pos = (495+0*self.prob_space-15,125)
                    self.etag0.pos = (495+1*self.prob_space-15,125)
                    self.etag1.pos = (495+2*self.prob_space-15,125)


                    self.rec_1.size = (self.prob_space-10, 250*self.prob[0][0])
                    self.rec0.size = (self.prob_space-10, 250*self.prob[0][1])
                    self.rec1.size = (self.prob_space-10, 250*self.prob[0][2])
                    ...
                    # Movem aquells que volem que es mostrin
                    self.rec_2.pos = (30 , 150)
                    self.rec_1.pos = (30 + 1 * self.prob_space, 150)
                    self.rec1.pos = (30 + 3 * self.prob_space, 150)
                    self.rec0.pos = (30 + 2 * self.prob_space, 150)
                    self.rec2.pos = (30 + 4 * self.prob_space, 150)

                    self.erec_2.pos = (500 + 0 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][0] * 100)
                    self.erec_1.pos = (500 + 1 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][1] * 100)
                    self.erec0.pos = (500 + 2 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][2] * 100)
                    self.erec1.pos = (500 + 3 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][3] * 100)
                    self.erec2.pos = (500 + 4 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][4] * 100)


                    self.tag_2.pos = (30 + 0 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag_1.pos = (30 + 1 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag0.pos = (30 + 2 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag1.pos = (30 + 3 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag2.pos = (30 + 4 * self.prob_space + self.prob_space / 2. - 15, 125)

                    self.etag_2.pos = (495 + 0 * self.prob_space - 15, 125)
                    self.etag_1.pos = (495 + 1 * self.prob_space - 15, 125)
                    self.etag0.pos = (495 + 2 * self.prob_space - 15, 125)
                    self.etag1.pos = (495 + 3 * self.prob_space - 15, 125)
                    self.etag2.pos = (495 + 4 * self.prob_space - 15, 125)


                    self.rec_2.size = (self.prob_space - 10, 250 * self.prob[0][0])
                    self.rec_1.size = (self.prob_space - 10, 250 * self.prob[0][1])
                    self.rec0.size = (self.prob_space - 10, 250 * self.prob[0][2])
                    self.rec1.size = (self.prob_space - 10, 250 * self.prob[0][3])
                    self.rec2.size = (self.prob_space - 10, 250 * self.prob[0][4])
                    ...
                    # Movem aquells que volem que es mostrin
                    self.rec_32.pos = (30, 150)
                    self.rec_12.pos = (30 + 1 * self.prob_space, 150)
                    self.rec12.pos = (30 + 2 * self.prob_space, 150)
                    self.rec32.pos = (30 + 3 * self.prob_space, 150)

                    self.erec_32.pos = (500 + 0 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][0] * 100)
                    self.erec_12.pos = (500 + 1 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][1] * 100)
                    self.erec12.pos = (500 + 2 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][2] * 100)
                    self.erec32.pos = (500 + 3 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][3] * 100)


                    self.tag_32.pos = (30 + 0 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag_12.pos = (30 + 1 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag12.pos = (30 + 2 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag32.pos = (30 + 3 * self.prob_space + self.prob_space / 2. - 15, 125)

                    self.etag_32.pos = (495 + 0 * self.prob_space - 15, 125)
                    self.etag_12.pos = (495 + 1 * self.prob_space - 15, 125)
                    self.etag12.pos = (495 + 2 * self.prob_space - 15, 125)
                    self.etag32.pos = (495 + 3 * self.prob_space - 15, 125)


                    self.rec_32.size = (self.prob_space - 10, 250 * self.prob[0][0])
                    self.rec_12.size = (self.prob_space - 10, 250 * self.prob[0][1])
                    self.rec12.size = (self.prob_space - 10, 250 * self.prob[0][2])
                    self.rec32.size = (self.prob_space - 10, 250 * self.prob[0][3])
                    ...
                    # Movem aquells que volem que es mostrin
                    self.rec_52.pos = (30 + 0 * self.prob_space, 150)
                    self.rec_32.pos = (30 + 1 * self.prob_space, 150)
                    self.rec_12.pos = (30 + 1 * self.prob_space, 150)
                    self.rec12.pos = (30 + 3 * self.prob_space, 150)
                    self.rec32.pos = (30 + 4 * self.prob_space, 150)
                    self.rec52.pos = (30 + 5 * self.prob_space, 150)

                    self.erec_52.pos = (500 + 0 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][0] * 100)
                    self.erec_32.pos = (500 + 1 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][1] * 100)
                    self.erec_12.pos = (500 + 2 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][2] * 100)
                    self.erec12.pos = (500 + 3 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][3] * 100)
                    self.erec32.pos = (500 + 4 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][4] * 100)
                    self.erec52.pos = (500 + 5 * self.prob_space - self.prob_space / 2., 300 + self.ene[0][5] * 100)

                    self.tag_52.pos = (30 + 0 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag_32.pos = (30 + 1 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag_12.pos = (30 + 2 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag12.pos = (30 + 3 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag32.pos = (30 + 4 * self.prob_space + self.prob_space / 2. - 15, 125)
                    self.tag52.pos = (30 + 5 * self.prob_space + self.prob_space / 2. - 15, 125)

                    self.etag_52.pos = (495 + 0 * self.prob_space - 15, 125)
                    self.etag_32.pos = (495 + 1 * self.prob_space - 15, 125)
                    self.etag_12.pos = (495 + 2 * self.prob_space - 15, 125)
                    self.etag12.pos = (495 + 3 * self.prob_space - 15, 125)
                    self.etag32.pos = (495 + 4 * self.prob_space - 15, 125)
                    self.etag52.pos = (495 + 5 * self.prob_space - 15, 125)

                    self.rec_52.size = (self.prob_space - 10, 250 * self.prob[0][0])
                    self.rec_32.size = (self.prob_space - 10, 250 * self.prob[0][1])
                    self.rec_12.size = (self.prob_space - 10, 250 * self.prob[0][2])
                    self.rec12.size = (self.prob_space - 10, 250 * self.prob[0][3])
                    self.rec32.size = (self.prob_space - 10, 250 * self.prob[0][4])
                    self.rec52.size = (self.prob_space - 10, 250 * self.prob[0][5])
            ...
            if self.mlt==3:
                ...
                m, n = self.erec_1.pos
                self.rec_1.size = (x0, y0 + self.vel[GameScreen.Comptador][0] * 5 * 250 * dt)
                self.erec_1.pos = (m, n + self.evel[GameScreen.Comptador][0] * 5 * 100 * dt)
                ...
                x2, y2 = self.rec1.size
                m, n = self.erec1.pos
                self.rec1.size = (x2, y2 + self.vel[GameScreen.Comptador][2] * 5 * 250 * dt)
                self.erec1.pos = (m, n + self.evel[GameScreen.Comptador][2] * 5 * 100 * dt)
            ...
            if self.mlt==5:
                ...
                m, n = self.erec_2.pos
                self.rec_2.size = (x0, y0 + self.vel[GameScreen.Comptador][0] * 5 * 250 * dt)
                self.erec_2.pos = (m, n + self.evel[GameScreen.Comptador][0] * 5 * 100 * dt)
                ...
                x3, y3 = self.rec1.size
                m, n = self.erec1.pos
                self.rec1.size = (x3, y3 + self.vel[GameScreen.Comptador][3] * 5 * 250*dt)
                self.erec1.pos = (m, n + self.evel[GameScreen.Comptador][3] * 5 * 10 * dt)

                x4, y4 = self.rec2.size
                m, n = self.erec2.pos
                self.rec2.size = (x4, y4 + self.vel[GameScreen.Comptador][4] * 5 * 250 * dt)
                self.erec2.pos = (m, n + self.evel[GameScreen.Comptador][4] * 5 * 10 * dt)

            if self.mlt==4:
                x0, y0 = self.rec_32.size
                m, n = self.erec_32.pos
                self.rec_32.size = (x0, y0 + self.vel[GameScreen.Comptador][0] * 5 * 250 * dt)
                self.erec_32.pos = (m, n + self.evel[GameScreen.Comptador][0] * 5 * 100 * dt)

                x1, y1 = self.rec_12.size
                m, n = self.erec_12.pos
                self.rec_12.size = (x1, y1 + self.vel[GameScreen.Comptador][1] * 5 * 250 * dt)
                self.erec_12.pos = (m, n + self.evel[GameScreen.Comptador][1] * 5 * 100 * dt)
                ...
                x3, y3 = self.rec32.size
                m, n = self.erec32.pos
                self.rec32.size = (x3, y3 + self.vel[GameScreen.Comptador][3] * 5 * 250 * dt)
                self.erec32.pos = (m, n + self.evel[GameScreen.Comptador][3] * 5 * 10 * dt)

            if self.mlt==6:
                x0, y0 = self.rec_52.size
                m, n = self.erec_52.pos
                self.rec_52.size = (x0, y0 + self.vel[GameScreen.Comptador][0] * 5 * 250 * dt)
                self.erec_52.pos = (m, n + self.evel[GameScreen.Comptador][0] * 5 * 100 * dt)

                x1, y1 = self.rec_32.size
                m, n = self.erec_32.pos
                self.rec_32.size = (x1, y1 + self.vel[GameScreen.Comptador][1] * 5 * 250 * dt)
                self.erec_32.pos = (m, n + self.evel[GameScreen.Comptador][1] * 5 * 100 * dt)
                ...
                x3, y3 = self.rec12.size
                m, n = self.erec12.pos
                self.rec12.size = (x3, y3 + self.vel[GameScreen.Comptador][3] * 5 * 250 * dt)
                self.erec12.pos = (m, n + self.evel[GameScreen.Comptador][3] * 5 * 10 * dt)

                x4, y4 = self.rec32.size
                m, n = self.erec32.pos
                self.rec32.size = (x4, y4 + self.vel[GameScreen.Comptador][4] * 5 *250* dt)
                self.erec32.pos = (m, n + self.evel[GameScreen.Comptador][4] * 5 * 10 * dt)

                x5, y5 = self.rec52.size
                m, n = self.erec32.pos
                self.rec52.size = (x5, y5 + self.vel[GameScreen.Comptador][5] * 5 * 250 * dt)
                self.erec52.pos = (m, n + self.evel[GameScreen.Comptador][5] * 5 * 10 * dt)
